...
public static class AppConstants
{
    ...
    public const string CsvFirstRow = "local_time,milliseconds,timestamp,imageset_id,head_pos_x,head_pos_y,head_pos_z,head_ori_x,head_ori_y,head_ori_z,gaze_hemi_x,gaze_hemi_y,obj_id,obj_pos_x,obj_pos_y,obj_pos_z,gaze_obj_x,gaze_obj_y,gaze_obj_z"; // gaze_vr_x,gaze_vr_y,scene_status,patientname,Session
